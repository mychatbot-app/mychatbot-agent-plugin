...
Call `get_account_summary` from mychatbot-sales, then use the smallest relevant
set of direct reads:
...
Call `get_account_authoring_inventory` from mychatbot-agents. Treat partial
inventory sections as unknown. Use `list_routines`, `get_routine_readiness`,
